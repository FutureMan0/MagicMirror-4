...
echo -e "${BLUE}==============================================${NC}"
echo -e "${BLUE}   MagicMirror3 Raspberry Pi Installer      ${NC}"
echo -e "${BLUE}==============================================${NC}"
...
echo -e "${GREEN}[4/6] Installing MagicMirror3 dependencies...${NC}"
...
CHOICE=$(whiptail --title "MagicMirror3 Setup" --menu "Detected Displays: $DISPLAY_COUNT\nChoose your HDMI configuration:" 15 60 4 \
