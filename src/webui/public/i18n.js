...
const translations = {
  de: {
    ...
    layoutZones: 'Zonen',
    layoutFree: 'Frei',
    mirrorBackdrop: 'Spiegel im Hintergrund',
    freeHint: 'Ziehen zum Verschieben, an der Ecke zum Vergrößern.',
    freeEmpty: 'Kein Modul aktiv.',
    freePick: 'Ein Modul antippen, um die Schrift einzustellen.',
    freeSizeHint: 'Die Größe stellst du durch Ziehen an der Ecke ein.',
    zonesConverted: 'Modul auf eine freie Position umgerechnet',
  ...
  en: {
    ...
    layoutZones: 'Zones',
    layoutFree: 'Free',
    mirrorBackdrop: 'Mirror behind',
    freeHint: 'Drag to move, drag the corner to resize.',
    freeEmpty: 'No module active.',
    freePick: 'Tap a module to set its font.',
    freeSizeHint: 'Set the size by dragging the corner.',
    zonesConverted: 'module converted to a free position',
